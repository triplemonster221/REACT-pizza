  ...
  return (
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className={styles.cartContentItems}>
            ...
            ? items.map((item) => (
                <div key={item.id} className="cart__item">
                  ...
                  <div className="cart__item-count">
                    <div onClick={() => hundleMinusCart(item.id)} className="button button--outline button--circle cart__item-count-minus">
                    ...
                    <b>{item.count}</b>
                    <div onClick={() => hundleAddProduct(item)} className="button button--outline button--circle cart__item-count-plus">
                      <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M5.92001 3.84V5.76V8.64C5.92001 9.17016 5.49017 9.6 4.96001 9.6C4.42985 9.6 4.00001 9.17016 4.00001 8.64L4 5.76L4.00001 3.84V0.96C4.00001 0.42984 4.42985 0 4.96001 0C5.49017 0 5.92001 0.42984 5.92001 0.96V3.84Z"
                          fill="#EB5A1E"
                  ...
                  <div onClick={() => handleRemoveProduct(item.id)} className="cart__item-remove">
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span>
              Всего пицц: <b>{allCountInCart} шт.</b>
            </span>
            <span>
